...
class SearchIndex(object):
    ...
    def add_anchors(self, html, save_path, search_type, anchors):

        for a in anchors:
            search_obj = {"id": None, "title": None, "tags": []}
            search_obj["id"] = len(self.index["data"])
            search_obj["title"] = a.label
            search_obj["link"] = save_path + a.link
            search_obj["tags"] = a.tags
